...
namespace NumberplateRecognition.Services
{
    ...
    /// </summary>
    public class OnnxTruckDetectionModel : ITruckDetectorModel
    {
        ...
        public OnnxTruckDetectionModel(string modelPath, string? executionProvider = null, Dictionary<string, string>? providerOption = null)
        {
